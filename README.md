...
Темы хакафона:
    ...
    Урбанистика,
    Наука данных на благо общества,
...
Хакафон посвящен теме здорового образа жизни в городе. В частности, он сосредоточен на основных темах, таких как наука данных для общественного блага, анализ больших данных гражданами, таких как данные о мобильности, данные о достижимости больниц и т.д. Одной из главных мотиваций хакафона является разработка будущих проектов между различными дисциплинами: управление и сбор открытых данных, урбанистические исследования, физика, анализ транспортных систем, информатика (методы машинного обучения, разработка быстрых и надежных алгоритмов для структур данных).
Участие
...
Если вам нужна виза, зайдите на сайт https://pulkovoairport.ru/en/passengers/evisa/ Не стесняйтесь задавать нам вопросы, если у вас возникнут какие-либо вопросы!
Регистрация

Регистрация на английском языке https://forms.gle/5YYGi1qtE1HP4yzq6 Пожалуйста, напишите нам, если вы хотите принять участие в конкурсе liubov.tupikina на сайте cr-paris.org inxaoc на gmail.com.
